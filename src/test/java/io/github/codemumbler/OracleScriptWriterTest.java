...
public class OracleScriptWriterTest {
  ...
  public void sequenceForAutoIncrement() {
    ...
    Assert.assertEquals("CREATE TABLE TEST_TABLE (\n" +
            ...
            "END;\n" +
            "/\n" +
            "ALTER TRIGGER TEST_TABLE_TRIG ENABLE;", writer.writeTableScript(table));
  }
  ...
  public void writeFullDDLScript() {
    createDatabase();
    Assert.assertEquals(
        "--CREATE USER TEST_SCHEMA IDENTIFIED BY password2Change;\n" + "-- GRANT CONNECT, RESOURCE, CREATE SESSION, CREATE TABLE, CREATE VIEW,\n"
  ...
  public void writeFullInsertionsTablesAddedReverseOrder() {
    ...
    Assert
        .assertEquals("INSERT INTO PARENT_TABLE(ID) VALUES (1);\nINSERT INTO TEST_TABLE(FOREIGN_ID) VALUES (1);\n", writer.writeDatabaseInsertions());
  }
